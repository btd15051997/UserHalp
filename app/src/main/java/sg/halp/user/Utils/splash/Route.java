package sg.halp.user.Utils.splash;
...
import sg.halp.user.Utils.AmbulancyUtils;
...
public class Route {
    ...
    private Paint createBasePaint(Context context) {
        ...
        paint.setColor(context.getResources().getColor(R.color.deeporange600));
    ...
    private Paint createOverlayPaint(Context context) {
        Paint paint = new Paint();
        paint.setColor(context.getResources().getColor(R.color.deeporange200));
        paint.setStyle(Style.STROKE);
        paint.setStrokeCap(Cap.ROUND);
