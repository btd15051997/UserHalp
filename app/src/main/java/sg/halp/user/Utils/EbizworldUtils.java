...
public class EbizworldUtils {
    ...
    public static void addFragment(Activity activity, int content_frame, Fragment fragment, boolean addToBackStack, String tag, boolean isAnimate) {
    ...
    public static void makeActivityAnimation(Activity start, Class<?> cls){

        Intent intent = new Intent(start, cls);
        ActivityOptions activityOptions = ActivityOptions.makeCustomAnimation(start, R.anim.slide_in_right, R.anim.slide_out_left);
        start.startActivity(intent, activityOptions.toBundle());
    }
