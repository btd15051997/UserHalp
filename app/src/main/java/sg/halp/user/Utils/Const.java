...
public class Const {
    ...
    public static final String CANCELLATION_FEE_BILLING_INFO_DIALOGFRAGMENT = "cancellation_fee_billing_info_dialogfragment";
    public static final String BILLING_INFO_SCHEDULE_DIALOGFRAGMENT = "billing_info_schedule_dialogfragment";
    public static final String PATIENT_SCHEDULE_DIALOGFRAGMENT = "patient_schedule_dialogfragment";
    public static final String CANCEL_REASON_DIALOGFRAGMENT = "cancel_reason_dialogfragment";
    public static final String REQUEST_LOADER_DIALOGFRAGMENT = "request_loader_dialogfragment";
    public static final String SHOW_PICTURE_DIALOGFRAGMENT = "show_picture_dialogfragment";
    public static final String SOCIAL_NETWORK_DIALOGFRAGMENT = "social_network_dialogfragment";
    public static final String PRE_SELECT_PAYMENT_DIALOGFRAGMENT = "pre_select_payment_dialogfragment";
    ...
    public static final int IS_PAID = 8;
    ...
    public class PreSelectPaymentParams{
    ...
    public class Params {
        ...
        public static final String OXYGEN_TANK ="oxygen_tank";
        ...
        public static final String PRICE_CANCEL_SCHEDULE = "price_cancel_schedule";
        public static final String CURRENCY = "currency";
        public static final String EXTRA_AMOUNT ="extra_amount";
        public static final String EXTRA_ITEM ="extra_item";
        public static final String IS_EXPENSES ="is_expenses";
    ...
    public class ServiceType {
        ...
        public static final String PRIVACY_POLICY_URL = HOST_URL + "privacy-policy";
        public static final String TERMS_CONDITIONS_URL = HOST_URL + "terms-conditions";
        ...
        public static final String POST_PAYPAL_NONCE_NORMAL_URL = BASE_URL + "paymentcheckout";
        public static final String POST_PAYPAL_NONCE_SCHEDULE_URL = BASE_URL + "paymentcancelschedule";
        ...
        public static final String GET_PRE_SELECT_PAYMENT_URL = BASE_URL + "paymentDetail?";
        public static final String UPDATE_PRE_SELECT_PAYMENT_URL = BASE_URL + "updatePaymentMethod";
        public static final String CHANGE_PASSWORD_URL = BASE_URL + "changePasswordPhone";
        public static final String OTP_RESET_PASSWORD_URL = BASE_URL + "sendOtpResetPassword?";
    ...
    public class NursingHomeService {
        ...
        public static final String POST_PAYPAL_NONCE_NORMAL_URL = NURSING_HOME_BASE_URL + "paymentcheckout";
        public static final String POST_PAYPAL_NONCE_SCHEDULE_URL = NURSING_HOME_BASE_URL + "paymentcancelschedule";
    ...
    public class HospitalService{
        ...
        public static final String POST_PAYPAL_NONCE_NORMAL_URL = HOSPITAL_BASE_URL + "paymentcheckout";
        public static final String POST_PAYPAL_NONCE_SCHEDULE_URL = HOSPITAL_BASE_URL + "paymentcancelschedule";
    ...
    public class NotificationParams {
        ...
        public static final String TYPE_TRIP_CANCEL = "cancel";
    ...
    public class ServiceCode {
        ...
        public static final int SOCIAL_LOGIN = 61;
        public static final int SOCIAL_REGISTER = 62;
        public static final int GET_PRE_SELECT_PAYMENT = 63;
        public static final int UPDATE_PRE_SELECT_PAYMENT = 64;
        public static final int CHANGE_PASSWORD = 65;
        public static final int OTP_RESET_PASSWORD = 66;
