...
public class ParseContent {
            ...
            if (jsonObject.getString(KEY_SUCCESS).equals("true")) {
                ...
                switch (new PreferenceHelper(activity).getLoginType()){
                    ...
                    case Const.PatientService.PATIENT:{
                        ...
                        if (jsonObject.has(Const.Params.CURRENCY_CODE)) {

                            preferenceHelper.putCurrency(jsonObject.getString(Const.Params.CURRENCY_CODE));

                        }

                        if (jsonObject.has(Const.Params.MOBILE)) {
                        ...
                        if (!preferenceHelper.getLoginBy().equalsIgnoreCase(Const.MANUAL) && jsonObject.has(Const.Params.SOCIAL_ID)) {
                            ...
                            preferenceHelper.putSocialId(jsonObject.getString(Const.Params.SOCIAL_ID));

                        }

                        if(jsonObject.has(Const.Params.PAYMENT_MODE)){
                            preferenceHelper.putPaymentMode(jsonObject.getString(Const.Params.PAYMENT_MODE));
                        }
    ...
    public boolean parseHospitalAndStoreToDatabaseByGSON(String response) {
        ...
        try {
            ...
            if (jsonObject.getBoolean(KEY_SUCCESS)) {
                ...
                Hospital hospital = gson.fromJson(jsonObject.toString(), Hospital.class);
                EbizworldUtils.appLogDebug("HaoLS", "JsonObject: " + jsonObject.toString());
                ...
                if (hospital != null){
                    ...
                    EbizworldUtils.appLogDebug("HaoLS", "parseHospitalAndStoreToDB succeeded: " + hospital.getId());
    ...
    public NursingHome parseNurseAndStoreToDb(String response) {
        ...
        try {
            ...
            if (jsonObject.getBoolean(KEY_SUCCESS)) {
                ...
                nursingHome.setId(jsonObject.getInt(Const.Params.ID));
                nursingHome.setmFullName(jsonObject.optString(Const.Params.FULLNAME));

                if (jsonObject.has(Const.Params.CONTACT_NAME)){

                    nursingHome.setmContact_Name(jsonObject.optString(Const.Params.CONTACT_NAME));

                }

                if (jsonObject.has(Const.Params.CONTACT_NO)){

                    nursingHome.setmContact_Number(jsonObject.optString(Const.Params.CONTACT_NO));

                }

                if (jsonObject.has(Const.Params.PREFERRED_USERNAME)){

                    nursingHome.setmPreferred_Username(jsonObject.optString(Const.Params.PREFERRED_USERNAME));

                }

                nursingHome.setmMobile(jsonObject.optString(Const.Params.MOBILE));
                preferenceHelper.putPhone(jsonObject.getString(Const.Params.MOBILE));

                nursingHome.setmEmail(jsonObject.optString(Const.Params.EMAIL));

                nursingHome.setmPictureUrl(jsonObject.getString(Const.Params.PICTURE));

                if (jsonObject.has(Const.Params.ADDRESS)){

                    nursingHome.setmAddress(jsonObject.optString(Const.Params.ADDRESS));

                }

                if (jsonObject.has(Const.Params.TIMEZONE)){

                    nursingHome.setmTimezone(jsonObject.getString(Const.Params.TIMEZONE));

                }

                if (jsonObject.has(Const.Params.OPERATOR_ID)){

                    nursingHome.setmOperatorID(Integer.parseInt(jsonObject.getString(Const.Params.OPERATOR_ID)));
                ...
                if (jsonObject.has(Const.Params.CURRENCY_CODE)) {
                    ...
                    nursingHome.setmCurrencyCode(jsonObject.getString(Const.Params.CURRENCY_CODE));
                    preferenceHelper.putCurrency(jsonObject.getString(Const.Params.CURRENCY_CODE));
                ...
                if (jsonObject.has(Const.Params.GENDER)) {
                    ...
                    nursingHome.setmGender(jsonObject.getString(Const.Params.GENDER));

                }

                if (jsonObject.has(Const.Params.COUNTRY)) {

                    nursingHome.setmCountry(jsonObject.getString(Const.Params.COUNTRY));

                }


                mRealm.beginTransaction();
                mRealm.copyToRealm(nursingHome);
                mRealm.commitTransaction();
    ...
    public boolean parseNurseAndStoreToDbByGSON(String response) {
        NursingHome nursingHome = null;
        try {
            JSONObject jsonObject = new JSONObject(response);
            ...
            if (jsonObject.getBoolean(KEY_SUCCESS)) {
                ...
                Gson gson = new Gson();
                nursingHome = gson.fromJson(jsonObject.toString(), NursingHome.class);
                EbizworldUtils.appLogDebug("HaoLS", "JsonObject: " + jsonObject.toString());
                ...
                if (nursingHome != null){
                    ...
                    mRealm.copyToRealm(nursingHome);
                    mRealm.commitTransaction();
                    EbizworldUtils.appLogDebug("HaoLS", "ParseNurseAndStoreDatabase success: " + nursingHome.getId());
            ...
            if (jsonObject.getBoolean(KEY_SUCCESS)) {
                ...
                if (jarray.length() > 0) {
                    ...
                    if (invoicejarray.length() > 0) {
                        ...
                        if (invoiceobj.has(Const.Params.EXTRA_ITEM)){

                            requestDetail.setExraItems(invoiceobj.getString(Const.Params.EXTRA_ITEM));

                        }

                        if (invoiceobj.has(Const.Params.EXTRA_AMOUNT)){

                            requestDetail.setExtraAmount(invoiceobj.getInt(Const.Params.EXTRA_AMOUNT));
                        }

                        if (invoiceobj.has(Const.Params.IS_EXPENSES)){

                            requestDetail.setIs_expense(invoiceobj.getString(Const.Params.IS_EXPENSES));
                        ...
                        if (invoiceobj.has(Const.Params.OXYGEN_TANK)){

                            requestDetail.setOxygen_tank(invoiceobj.getString(Const.Params.OXYGEN_TANK));
                        }
                            ...
                            if (driverdata.has("provider_status") && driverdata.has("later")) {
                                ...
                                if (driverdata.getInt("provider_status") > 0 &&
                                    ...
                                    if (invoiceJSONArray.length() > 0) {
                                        ...
                                        if (invoiceObject.has(Const.Params.OXYGEN_TANK)){

                                            requestDetail.setOxygen_tank(invoiceObject.getString(Const.Params.OXYGEN_TANK));
                                        }
            ...
            if (scheduleObject.getString("success").equals("true")){
                ...
                if (scheduleArray.length() > 0) {
                    ...
                    for (int i = 0; i < scheduleArray.length(); i++) {
                        ...
                        schedule.setOperatorName(object.getString("service_type_name"));
