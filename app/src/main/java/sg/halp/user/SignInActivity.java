...
public class SignInActivity extends AppCompatActivity implements View.OnClickListener, AsyncTaskCompleteListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_login_password = (EditText) findViewById(R.id.edt_login_password);
        et_login_userid = (EditText) findViewById(R.id.edt_login_userid);
        btn_forgot_pass = (TextView) findViewById(R.id.btn_forgot_pass);
        btn_new_user = (TextView) findViewById(R.id.btn_new_user);
        log_layout = (RelativeLayout) findViewById(R.id.login_layout);
        ...
        lay_fb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LoginManager.getInstance()
                        .logInWithReadPermissions(SignInActivity.this, Arrays.asList("public_profile", "email", "user_birthday", "user_photos", "user_location"));
                loginType = Const.SOCIAL_FACEBOOK;
            }
        });
    ...
    public void onTaskCompleted(String response, int serviceCode) {
        switch (serviceCode) {
            ...
            case Const.ServiceCode.NURSE_LOGIN:{
                Log.d("HaoLS", "NursingHome loginManual Response " + response);
                Commonutils.progressDialog_hide();
            ...
            case Const.ServiceCode.HOSPITAL_LOGIN:{
                Log.d("HaoLS", "Hospital loginManual Response " + response);
                Commonutils.progressDialog_hide();
