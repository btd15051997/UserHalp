...
public class AmbulanceOperator {
    ...
    public AmbulanceOperator() {

    }

    public AmbulanceOperator(String id,
                             String ambulanceOperator,
                             String ambulanceImage,
                             String ambulanceCost,
                             String ambulanceSeats,
                             String ambulance_price_min,
                             String currencey_unit,
                             String ambulance_price_distance,
                             String basefare) {
        this.id = id;
