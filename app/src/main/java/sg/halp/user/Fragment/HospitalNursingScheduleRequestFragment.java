...
import sg.halp.user.Adapter.NurseBookingScheduleAdapter;
...
import sg.halp.user.Models.DistanceMatrix;
import sg.halp.user.Models.FareCaculation;
...
public class HospitalNursingScheduleRequestFragment extends Fragment implements View.OnClickListener, AsyncTaskCompleteListener, AdapterCallback {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        switch (new PreferenceHelper(activity).getLoginType()){
            ...
            case Const.NursingHomeService.NURSING_HOME:{
                ...
                new AmbulanceOperatorListAPI(activity, this).getAmbulanceOperatorForNursingHome(Const.ServiceCode.AMBULANCE_OPERATOR);
            ...
            case Const.HospitalService.HOSPITAL:{
                ...
                new AmbulanceOperatorListAPI(activity, this).getAmbulanceOperatorForHospital(Const.ServiceCode.AMBULANCE_OPERATOR);
            ...
            case R.id.btn_register_schedule_submit:{
                ...
                for (int i = 0; i < mScheduleList.size(); i++){
                    ...
                    try {
                        ...
                        jsonObject.put(Const.Params.OXYGEN_TANK, mScheduleList.get(i).getOxygen_tank());
                ...
                if (mAmbulanceOperatorsMain.size() > 0 && jsonArray.length() > 0 && activity != null){
                    ...
                    if (new PreferenceHelper(activity).getLoginType().equals(Const.NursingHomeService.NURSING_HOME)){
                        ...
                        new ScheduleRequestAPI(activity, this)
                                .bookNursingHomeSchedule(Const.ServiceCode.NURSE_HOSPITAL_REGISTER_SCHEDULE, jsonArray);

                    }else if (new PreferenceHelper(activity).getLoginType().equals(Const.HospitalService.HOSPITAL)){

                        new ScheduleRequestAPI(activity, this)
                                .bookHospitalSchedule(Const.ServiceCode.NURSE_HOSPITAL_REGISTER_SCHEDULE, jsonArray);
    ...
    public void onTaskCompleted(String response, int serviceCode) {
        ...
        switch (serviceCode){
                    ...
                    try {
                        ...
                        if (jsonObject.getString("success").equals("true")){
                            ...
                            if (object.has(Const.Params.OTHER_EXPENSES)){
                                ...
                                String other_expense = object.getString(Const.Params.OTHER_EXPENSES);
                            ...
                            billingInfoScheduleDialog.setCancelable(false);
                            ...
                            billingInfoScheduleDialog.setBillingInfoCallback(new DialogFragmentCallback.BillingInfoCallback() {
                                @Override
                                public void onConfirmListener(Boolean isConfirm) {
                                ...
                                @Override
                                public void onCancelListener(Boolean isCancel) {
            ...
            case Const.ServiceCode.NURSE_HOSPITAL_REGISTER_SCHEDULE:{
                ...
                EbizworldUtils.appLogInfo("HaoLS", "NURSE_HOSPITAL_REGISTER_SCHEDULE: " + response);
                if (response != null){
                    ...
                    if (activity != null){
                        ...
                        try{
                            ...
                            e.printStackTrace();
                            EbizworldUtils.appLogError("HaoLS", "NursingHome/Hospital register schedule failed " + e.toString());
                            EbizworldUtils.showShortToast(activity.getResources().getString(R.string.txt_trip_schedule_fail), activity);
                        }
                ...
                public void onClick(View view) {
                    ...
                    if (tv_time_date_pickup.getText().toString().length() == 0) {
                        ...
                        if (new PreferenceHelper(activity).getLoginType().equals(Const.NursingHomeService.NURSING_HOME)){
                            ...
                            new BillingInfoAPI(activity, HospitalNursingScheduleRequestFragment.this)
                                    .getNursingHomeScheduleBillingInfo(mSchedule, Const.ServiceCode.BILLING_INFO);

                        }else if (new PreferenceHelper(activity).getLoginType().equals(Const.HospitalService.HOSPITAL)){

                            new BillingInfoAPI(activity, HospitalNursingScheduleRequestFragment.this)
                                    .getHospitalScheduleBillingInfo(mSchedule, Const.ServiceCode.BILLING_INFO);
