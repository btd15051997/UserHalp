...
import sg.halp.user.Utils.MarkerUtils.SmoothMoveMarker;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (selectedSourcePlace != null){
                    ...
                    try {
                        ...
                        new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                                .getLatLngFromSourceAddress(URLEncoder.encode(selectedSourcePlace, "utf-8"), Const.ServiceCode.LOCATION_API_BASE_SOURCE);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (selectedDestPlace != null){
                    ...
                    try {
                        ...
                        new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                                .getLatLngFromSourceAddress(URLEncoder.encode(selectedDestPlace, "utf-8"), Const.ServiceCode.LOCATION_API_BASE_SOURCE);
        ...
        if(sourceAddress != null){
            ...
            try {
                ...
                new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                        .getLatLngFromSourceAddress(URLEncoder.encode(source_address, "utf-8"), Const.ServiceCode.LOCATION_API_BASE_SOURCE);
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
                ...
                activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (s_click == true) {
                            ...
                            new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                                    .getCompleteAddress(place.getLatLng(), Const.ServiceCode.GEO_DEST);
        ...
        search_dai_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                            .getLatLngFromSourceAddress(URLEncoder.encode(et_source_dia_address.getText().toString(), "utf-8"), Const.ServiceCode.LOCATION_API_BASE_SOURCE);

                    if (!(et_destination_dia_address.getText().toString().length() == 0)) {

                        new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                                .getLatLngFromDestinationAddress(URLEncoder.encode(et_destination_dia_address.getText().toString(), "utf-8"), Const.ServiceCode.LOCATION_API_BASE_DESTINATION);
                    }
                } catch (UnsupportedEncodingException e) {
                    e.printStackTrace();
                }
        ...
        et_destination_dia_address.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                            .getLatLngFromDestinationAddress(URLEncoder.encode(selectedplace, "utf-8"), Const.ServiceCode.LOCATION_API_BASE_DESTINATION);
                ...
                if (gMap != null) {
                    ...
                    gMap.setOnCameraChangeListener(new GoogleMap.OnCameraChangeListener() {
                        ...
                        public void onCameraChange(CameraPosition cameraPosition) {
                            ...
                            new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                                    .getCompleteAddress(cameraPosition.target, Const.ServiceCode.ADDRESS_API_BASE);
                            btn_done.requestFocus();
    ...
    public void onTaskCompleted(final String response, int serviceCode) {
        switch (serviceCode) {
            ...
            case Const.ServiceCode.LOCATION_API_BASE_SOURCE:{
                ...
                EbizworldUtils.appLogInfo("HaoLS", "LOCATION_API_BASE_SOURCE: " + response);
            ...
            case Const.ServiceCode.GEO_DEST:{
                ...
                EbizworldUtils.appLogInfo("HaoLS", "GEO_DEST: " + response);
            ...
            case Const.ServiceCode.ADDRESS_API_BASE:{
                ...
                EbizworldUtils.appLogInfo("HaoLS", "ADDRESS_API_BASE: " + response);
            ...
            case Const.ServiceCode.LOCATION_API_BASE_DESTINATION:{
                ...
                EbizworldUtils.appLogInfo("HaoLS", "LOCATION_API_BASE_DESTINATION: " + response);
                ...
                googleMap.setOnCameraIdleListener(new GoogleMap.OnCameraIdleListener() {
                    ...
                    public void onCameraIdle() {
                        if (d_click) {
                            ...
                            new LatLngGoogleAPI(activity, SearchPlaceFragment.this)
                                    .getCompleteAddress(des_latLng, Const.ServiceCode.ADDRESS_API_BASE);
