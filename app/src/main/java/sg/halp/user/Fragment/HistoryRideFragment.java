...
import sg.halp.user.Adapter.HistoryAdapter;
import sg.halp.user.Interface.AsyncTaskCompleteListener;
import sg.halp.user.Models.History;
...
import sg.halp.user.restAPI.HistoryListAPI;
                                ...
                                if (hisArray.length() > 0) {
                                    for (int i = 0; i < hisArray.length(); i++) {
                                        ...
                                        if (jsonObject.has(Const.Params.OXYGEN_TANK)){
                                            ...
                                            history.setOxygen_tank(jsonObject.getString(Const.Params.OXYGEN_TANK));
                                        }
