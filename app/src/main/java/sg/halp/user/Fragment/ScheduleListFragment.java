...
import sg.halp.user.Adapter.ScheduleAdapter;
    ...
    private void showDetailPatientSchedule (final Schedule schedule){
        ...
        if (mMainActivity != null){
            ...
            if (schedule !=null){
                ...
                trip_ambulance_operator.setText(schedule.getOperatorName());
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            /*case R.id.btn_add_schedule:{
                ...
                mMainActivity.addFragment(new HospitalNursingScheduleRequestFragment(), false, Const.NURSE_REGISTER_SCHEDULE_FRAGMENT, true);
